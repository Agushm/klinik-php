...
function obat(){
	$server = mysqli_connect("localhost","root","passw0rd","klinik");
								$pas = "SELECT * FROM pasien";
								$pasDb = mysqli_query($server,$pas) or die ("error get pasien".mysqli_error());
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
				<form action="" method="post">
					...
					<div class="form-group">
							<label class="control-label col-lg">Role</label>
							<div class="col-lg">
				...
				<div class="modal-body">
					<form action="" method="post">
						...
						<div class="form-group">
							...
							<input type="text" required class="form-control" name="ukuran"/>
						</div>
						<div class="form-group">
							...
							<input type="submit" class="btn btn-primary" name="obat" value="Tambah"/>
							<input type="reset" class="btn btn-warning" value="Close" data-dismiss="modal"/>
					</form>
				</div>
			</div>
