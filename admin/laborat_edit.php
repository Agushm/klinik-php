...
$edit = mysqli_query("select * from laboratorium where kd_lab='".$_GET["nmr"]."'");
$editDb = mysqli_fetch_assoc($edit);
	if($_POST["lab"]){
			include_once("../library/koneksi.php");
			mysqli_query("update laboratorium set no_rm='".$_POST["tgl"]."', hasil_lab='".$_POST["hasil"]."', ket='".$_POST["ket"]."' where kd_lab='".$_GET["nmr"]."'");
			...
			<form action="" method="post" class="form-horizontal">
						<div class="form-group">
							...
							<?php
								...
								$rmDb = mysqli_query($rm,$server) or die(mysqli_error());
