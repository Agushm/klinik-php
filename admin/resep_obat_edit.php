...
$edit = mysqli_query("select * from obat where kd_obat='".$_GET["nmr"]."'");
$editDb = mysqli_fetch_assoc($edit);
	if($_POST["obt"]){
			include_once("../library/koneksi.php");
			mysqli_query("update obat set nm_obat='".$_POST["nama"]."', jml_obat='".$_POST["jml"]."', ukuran='".$_POST["ukr"]."', harga='".$_POST["hrg"]."' where kd_obat='".$_GET["nmr"]."'");
