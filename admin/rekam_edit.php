...
$edit = mysqli_query("select * from rekam_medis where no_rm='".$_GET["nmr"]."'");
$editDb = mysqli_fetch_assoc($edit);
	if($_POST["rm"]){
			include_once("../library/koneksi.php");
			mysqli_query("update rekam_medis set kd_tindakan='".$_POST["tdk"]."', kd_obat='".$_POST["obt"]."', kd_user='".$_POST["pn"]."', no_pasien='".$_POST["pas"]."', diagnosa='".$_POST["diag"]."', resep='".$_POST["res"]."', keluhan='".$_POST["kel"]."', ket='".$_POST["ket"]."', tgl_pemeriksaan='".time()."' where no_rm='".$_GET["nmr"]."'");
			...
			<form action="" method="post" class="form-horizontal">
						<div class="form-group">
							...
							<?php
								...
								$tdkDb = mysqli_query($tdk,$server) or die(mysqli_error());
						...
						<div class="form-group">
							...
							<?php
								...
								$obtDb = mysqli_query($obt,$server) or die(mysqli_error());
						...
						<div class="form-group">
							...
							<?php
								...
								$pnDb = mysqli_query($pn,$server) or die(mysqli_error());
						...
						<div class="form-group">
							...
							<?php
								...
								$pasDb = mysqli_query($pas,$server) or die(mysqli_error());
