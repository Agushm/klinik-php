				...
				<tbody>
					<tr>
						...
						<td>
						  ...
						  <a href="?menu=edit_pasien&aksi=edit&nmr=<?php echo $pasien['no_rm']; ?>" class="btn btn-xs btn-info tipsy-kiri-atas" title='Edit Data ini'> <i class="icon-edit icon-white"></i> </a>
						  </div>
						</td>
					</tr>
				</tbody>
