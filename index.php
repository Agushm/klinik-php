...
<head>
     <meta charset="UTF-8" />
    <title>SISTEM INFORMASI PENDAFTARAN KLINIK</title>
...
if(@$_POST["login"]){ //jika tombol Login diklik
	...
	if($user!="" && $pass!=""){
		include_once("library/koneksi.php");
		$em = mysqli_query( $server,"select * from users where password = '$pass' AND username = '$user'");
...
?>
   <!-- PAGE CONTENT --> 
    ...
    <div class="text-center">
        <img src="img/klinik.png" id="logoimg" alt=" Logo" />
    </div>
